...
@[target] lemma prod_indicator_biUnion_sub_indicator (hs : s.Nonempty) (S : ι → Finset α) (a : α) :
...
@[target] theorem inclusion_exclusion_card_biUnion (s : Finset ι) (S : ι → Finset α) :
...
@[target] theorem inclusion_exclusion_card_inf_compl (s : Finset ι) (S : ι → Finset α) :
